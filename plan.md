...
## 23. Từ vựng theo Bài học — Lọc N5/N4/N3/N2/N1 theo từng Bài (2026-07-20)

### 23.1 Mô tả yêu cầu

Thêm chế độ lọc **"Lọc theo Bài"** trên trang Từ Vựng (`VocabularyPage`).

- Khi người dùng chọn **N5** → xuất hiện danh sách **Bài 1 → Bài 25**, mỗi bài có mô tả chủ đề trọng tâm.
- Khi chọn một bài cụ thể → chỉ hiện các từ vựng thuộc dải STT tương ứng trong DB.
- Tương tự cho N4, N3, N2, N1 (nội dung bài học sẽ được cập nhật sau).

### 23.2 Mapping N5 — Bài học ↔ Dải STT từ vựng

| Bài | Chủ đề trọng tâm | STT |
|-----|-----------------|-----|
| Bài 1 | Giới thiệu bản thân: Đại từ nhân xưng, nghề nghiệp, quốc gia | 1–25, 60 |
| Bài 2 | Chỉ thị từ & Đồ vật: 本, 辞書, 机, 鍵, 時計 | 26–51 |
| Bài 3 | Địa điểm & Mua sắm: 教室, 食堂, tiền tệ | 52–74 |
| Bài 4 | Thời gian & Động từ sinh hoạt: 起きる, 寝る, 時, 分 | 75–119 |
| Bài 5 | Di chuyển: 行く, 来る, 帰る, phương tiện | 120–158 |
| Bài 6 | Hành động hàng ngày: 食べる, 飲む, đồ ăn | 159–192 |
| Bài 7 | Công cụ & Cho/Nhận: 切る, 上げる, gia đình | 193–230 |
| Bài 8 | Tính từ: 奇麗, 静か, 大きい, thời tiết | 231–275 |
| Bài 9 | Sở thích & Khả năng: 好き, 嫌い, 上手 | 276–317 |
| Bài 10 | Sự tồn tại & Vị trí: imasu/arimasu, 上/下/前 | 318–360 |
| Bài 11 | Số đếm & Lượng từ: ～時間, ～週間 | 361–368 |
| Bài 12 | So sánh & Tính từ thời tiết: 暖かい, mùa | 369–395 |
| Bài 13 | Mong muốn & Mục đích: 欲しい, 遊ぶ | 396–428 |
| Bài 14 | Chia Thể Te nhóm 1: 付ける, 消す, 開ける | 429–461 |
| Bài 15 | Chia Thể Te nhóm 2: 立つ, 座る, 住んでいる | 462–486 |
| Bài 16 | Chuỗi hành động & Cơ thể: 歩く, 頭, 顔 | 487–524 |
| Bài 17 | Thể Nai: 忘れる, quần áo, y tế | 525–558 |
| Bài 18 | Thể Jisho: 出来る, 洗う, động vật | 559–586 |
| Bài 19 | Thể Ta – Kinh nghiệm: 登る, 泊まる | 587–608 |
| Bài 20 | Thể thông thường: 要る, 調べる, xưng hô thân mật | 609–622 |
| Bài 21 | Trích dẫn & Ý kiến: 思う, 言う, chính trị | 623–658 |
| Bài 22 | Bổ nghĩa danh từ: 着る, 履く, nhà cửa | 659–670 |
| Bài 23 | Thời điểm & Điều kiện: 聞く, 回す, giao thông | 671–695 |
| Bài 24 | Cho/Nhận nâng cao: 呉れる, 連れて行く, ông bà | 696–712 |
| Bài 25 | Điều kiện giả định: 考える, 着く, kết thúc khóa học | 713–730 |
...
```
[Trang Từ Vựng]
├── [Tabs: Tất cả | N5 | N4 | N3 | N2 | N1]  ← Đã có
│    └── Khi chọn N5 → hiện thêm panel lọc theo Bài
│         ├── [Tất cả bài N5]  ← Default
│         ├── [Bài 1: Giới thiệu bản thân]
│         ├── [Bài 2: Chỉ thị từ & Đồ vật]
│         └── ... đến Bài 25
└── [Danh sách từ vựng]  ← Lọc theo bài đã chọn
```

#### Giao diện:
- Hiển thị dạng **horizontal scroll chips** bên dưới thanh lọc N5/N4/N3 hiện tại.
- Mỗi chip bài học hiển thị: số bài + chủ đề ngắn (vd: `Bài 1 · Giới thiệu`).
- Khi chọn một bài → highlight chip + lọc list từ theo dải STT.
- Chip "Tất cả bài N5" reset về filter N5 thường.

#### Cơ chế lọc kỹ thuật:
- STT trong DB tương ứng với field `stt` (hoặc `id`).
- Khi chọn Bài X → `apiService.getVocabulary({ level: 'N5', sttFrom: X_min, sttTo: X_max })`.
- **Trường hợp đặc biệt**: Bài 1 gồm STT 1–25 VÀ STT 60 → cần fetch 2 range hoặc filter client-side.
- Nếu backend chưa hỗ trợ filter STT range → filter từ danh sách trả về theo `entry.stt`.

### 23.4 Files cần thay đổi

| File | Thay đổi |
|------|---------|
| `frontend/src/constants/lessonData.ts` | **[NEW]** Tạo file định nghĩa mapping bài học → STT range cho từng cấp độ |
| `frontend/src/pages/VocabularyPage.tsx` | Thêm state `lessonFilter`, hiển thị chip lọc bài khi đang chọn N5 (và N4/N3/N2/N1 sau) |
| `frontend/src/services/apiService.ts` | Mở rộng thêm param `sttFrom`, `sttTo` vào `getVocabulary()` nếu backend hỗ trợ |
| `backend/.../VocabularyController.cs` | (Tùy chọn) Thêm query param `sttFrom`, `sttTo` để filter theo dải STT |

### 23.5 Cấu trúc data `lessonData.ts`

```ts
export interface LessonDefinition {
  lessonNum: number;
  title: string;         // "Bài 1"
  theme: string;         // "Giới thiệu bản thân"
  sttRanges: [number, number][]; // [[1, 25], [60, 60]]
}
...
### 23.6 Kế hoạch thực thi

- [ ] Tạo `frontend/src/constants/lessonData.ts` với N5 lesson map đầy đủ
- [ ] Thêm state `lessonFilter: LessonDefinition | null` vào `VocabularyPage.tsx`
- [ ] Render **Lesson Chips Panel** khi `levelFilter === 'N5'` (và N4/N3/N2/N1 khi có data)
- [ ] Sau khi fetch từ API, filter phía client theo `sttRanges` nếu `lessonFilter !== null`
- [ ] CSS responsive cho Lesson Chips (horizontal scroll trên mobile Android)
- [ ] Test với Bài 1 (2 range: 1-25 + 60)

### 23.7 Ưu tiên

> **High Priority** — đây là tính năng học tập cốt lõi, giúp học sinh học từ vựng theo đúng lộ trình sách Minna no Nihongo.
